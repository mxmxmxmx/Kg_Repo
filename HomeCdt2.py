...
def feature_engineering(app_data, bureau_df, bureau_balance_df, credit_card_df,
    ...
    print('added number of features: {}'.format(prev_apps.shape[1]))
    ...
    print('added number of features: {}'.format(prev_apps_avg.shape[1]))
    ...
    print('added number of features: {}'.format(credit_card_avgs.shape[1]))
    ...
    print('added number of features: {}'.format(credit_card_df.shape[1]))
    ...
    print('added number of features: {}'.format(credit_bureau_avgs.shape[1]))
    ...
    print('added number of features: {}'.format(bureau_balance_df.shape[1]))
    ...
    print('added number of features: {}'.format(cash_avg.shape[1]))
    ...
    print('added number of features: {}'.format(pos_cash_df.shape[1]))
    ...
    print('added number of features: {}'.format(ins_avg.shape[1]))
